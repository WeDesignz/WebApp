...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback((el: HTMLElement) => {
    ...
    img.src = rawSrc;
    img.alt = rawAlt;
    img.style.cssText = `width:100%; height:100%; object-fit:cover; filter:${grayscale ? 'grayscale(0)' : 'none'};`;
  ...
  useGesture(
    ...
    { 
      target: mainRef, 
      eventOptions: { passive: false } // Need non-passive to conditionally prevent default
    }
  );
          ...
          <div className="stage">
            <div ref={sphereRef} className="sphere">
              {items.map((it, i) => (
                ...
                >
                  <div
                    className="item__image absolute block overflow-hidden cursor-pointer bg-muted/30 transition-transform duration-300 hover:scale-105"
                    role="button"
                    tabIndex={0}
