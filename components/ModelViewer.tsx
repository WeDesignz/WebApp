...
// Guard to ensure this only runs in browser
if (typeof window === 'undefined') {
  throw new Error('ModelViewer can only be used in the browser');
}
...
const ModelViewer: FC<ViewerProps> = ({
	...
	const capture = () => {
		const g = rendererRef.current, s = sceneRef.current, c = cameraRef.current as any;
		if (!g || !s || !c) return;
