...
const cardData: (BentoCardProps & { image?: string })[] = [
  { color: '#060010', title: 'Analytics', description: 'Track user behavior', label: 'Insights', image: '/generated_images/Modern_UI_Dashboard_Design_159dd6b9.png' },
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  return (
    <>
      {/* Expose CSS vars via root container for global styles to consume */}
      <div style={{ ['--glow-color' as any]: glowColor } as React.CSSProperties}>
      {enableSpotlight && (
        <GlobalSpotlight
          gridRef={gridRef}
          ...
          {cardData.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  {card.image && (
                    <img src={card.image} alt={card.title || ''} className="absolute inset-0 w-full h-full object-cover opacity-35" />
                  )}
