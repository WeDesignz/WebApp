...
import { X, ShoppingCart, Tag, ArrowRight, Trash2, Heart } from "lucide-react";
...
export default function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  const { cartItems, removeFromCart, moveToWishlist, getCartTotal } = useCartWishlist();
  ...
  const handleMoveToWishlist = (itemId: string, title: string) => {
    moveToWishlist(itemId);
    toast({
      title: "Moved to wishlist",
      description: `${title} has been saved to your wishlist.`,
    });
  };
